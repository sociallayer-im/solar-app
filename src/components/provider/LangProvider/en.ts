...
const langEN = {
  ...
  IssueFinish_Title: 'Send Successfully',
  PresendFinish_Title: 'Send Successfully',
  IssueFinish_IssuedToOne: slotLang('You\'ve sent badges to <br/> <b>{1}</b>'),
  IssueFinish_IssuedToMany: slotLang('You\'ve sent badges to <br/>  <b>{1}</b> <br/> and other <b>{2}</b> receivers!'),
  IssueFinish_GoAndInform: 'Go and inform',
  IssueFinish_CopyLink: 'Copy link',
  IssueFinish_BackToProfile: 'Back to Profile',
  IssueFinish_success: 'You\'ve sent badges Successfully !',
  ...
  Presend_step: 'Fill in the quantity of badges, the badges will be sent to the receivers as a link.',
