...
const langEN = {
  ...
  Profile_User_IssueBadge: 'Issue a badge',
  ...
  MintFinish_Button_Later: 'Issue later',
  MintFinish_Button_Issue: 'Go to issue',

  IssueBadge_Title: 'Issue a badge',
  IssueBadge_Domain: 'Badge Domain',
  IssueBadge_Reason: 'Reason',
  IssueBadge_ReasonPlaceholder: 'Reason for issuing',
  IssueBadge_Issuees: 'Issuee(s)',
  IssueBadge_Support: 'Support <br />1.wallet address; <br/>2. domain end with \'.dot/.eth\'; <br /> 3.Social Layer username or user domain',
  IssueBadge_IssueesPlaceholder: 'Enter issuer\'s domain or wallet address',
  IssueBadge_GoToIssue: 'Go to issue',
  IssueBadge_Issuesing: 'Minting',
  IssueBadge_Sendwithlink: 'Send with a link',
  IssueBadge_Sendwithdomain: 'Send to domains',
  ...
  IssueFinish_success: 'You\'ve issued badges Successfully !',
  IssueFinish_share: '#1 has issued you an NFT badge: #2. Go and get it!\n #3 \n It is recommended to use metamask or imToken browser to access the website.',
  ...
  Landing_Sub_Tittle_3: 'How to issue a badge?',
  Landing_Des_1: 'A dApp where anyone can issue badges to anyone, building a person\'s digital identity based on subjective, unquantifiable value. Badge issuance is not subject to third-party review or approval, and the most valuable badges will naturally spring up in the multivalued community.',
  ...
  WhatsApp_Share: slotLang('{domain} issued you an NFT badge: {badge}. Go get it! {url}'),
  ...
  ThanksgivingCard_1: 'Give you a Thanksgiving badge',
  ThanksgivingCard_2: 'Accept badge',
  ThanksgivingCard_screenshot: 'Please screenshot to save',
  ...
  Group_invite_share: '#1 has issued you an NFT badge: #2. Go and get it! \n #3 \n It is recommended to use metamask or imToken browser to access the website.',
