...
describe('Input', async () => {
    ...
    it('通过传入选中值，值对应的列表项显示“选中”标记', () => {
        ...
        expect(screen.getByTestId('AddressListItem').querySelector('.list-item')).toContainHTML('<i class="icon icon-selected" title="selected"></i>')
    })
    ...
    it('通过列表项，回调函数输出选中值', () => {
        ...
        userEvent.click(screen.getByTestId('AddressListItem').querySelector('.list-item')!)
